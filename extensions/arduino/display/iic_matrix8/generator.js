...
function addGenerator (Blockly) {
    ...
    Blockly.Arduino.matrix_iic_face = function (block) {
        ...
        'uint8_t matrix_front[8]={0x00,0x00,0x00,0x42,0xa5,0x5a,0x24,0x18};\n'+
        'uint8_t matrix_back[8]={0x00,0x18,0x24,0x5a,0xa5,0x42,0x00,0x00};\n'+
        'uint8_t matrix_left[8]={0x08,0x14,0x0a,0x05,0x05,0x0a,0x14,0x08};\n'+
        'uint8_t matrix_right[8]={0x10,0x28,0x50,0xa0,0xa0,0x50,0x28,0x10};\n'+
