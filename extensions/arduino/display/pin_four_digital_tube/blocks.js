...
function addBlocks (Blockly) {
    ...
    Blockly.Blocks.tb4_number = {
        init: function () {
            this.jsonInit({
                message0: '%1',
                message1: Blockly.Msg.PINFOURTUBE_STRING,
                args0: [
                    {
                        type: 'field_image',
                        src: tb4IconUrl,
    ...
    Blockly.Blocks.tb4_dot = {
        init: function () {
            this.jsonInit({
                message0: '%1',
                message1: Blockly.Msg.PINFOURTUBE_DOT,
                args0: [
                    {
                        type: 'field_image',
                        src: tb4IconUrl,
    ...
    Blockly.Blocks.tb4_state = {
        init: function () {
            this.jsonInit({
                message0: '%1',
                message1: Blockly.Msg.PINFOURTUBE_STATE,
                args0: [
                    {
                        type: 'field_image',
                        src: tb4IconUrl,
