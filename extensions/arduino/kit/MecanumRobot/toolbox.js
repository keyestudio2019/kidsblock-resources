...
<category name="%{BKY_LED_CATEGORY}" id="LED_CATEGORY" colour="#FF6F00" secondaryColour="#FF6F00">
    <block type="led" id="led">

    </block>
</category>

<category name="%{BKY_CAR_SERIAL_CATEGORY}" id="CAR_SERIAL_CATEGORY" colour="#FF6F00" secondaryColour="#FF6F00">
    <block type="car_serial" id="car_serial">

    </block>
</category>

<category name="%{BKY_RGB6812_CATEGORY}" id="RGB6812_CATEGORY" colour="#FF6F00" secondaryColour="#FF6F00">
    <block type="rgb6812_init" id="rgb6812_init">
    ...
    <block type="rgb6812_brightness" id="rgb6812_brightness">
        <field name="pin">4</field>>
    ...
    <block type="rgb6812_show" id="rgb6812_show">
        <field name="pin">4</field>>
    </block>

    <block type="rgb6812_clear" id="rgb6812_clear">
        <field name="pin">4</field>>
    </block>
