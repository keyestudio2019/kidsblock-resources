...
function addGenerator (Blockly) {
    ...
    Blockly.Arduino.matrix_iic_face = function (block) {
        Blockly.Arduino.definitions_[`1matrix_face`] = 'uint8_t matrix_smile[8]={0x42, 0xa5, 0xa5, 0x00, 0x00, 0x24, 0x18, 0x00};\n'+
    ...
    Blockly.Arduino.matrix_iic_piexl = function (block) {
        ...
        return 'myMatrix.drawPixel(7-'+xVal+','+yVal+','+matrix_state+');\n';
    };
