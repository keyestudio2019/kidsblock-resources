...
function addBlocks (Blockly) {
    ...
    Blockly.Blocks.gesture_init = {
        init: function () {
            this.jsonInit({
                message0: '%1',
                message1: Blockly.Msg.GESTURE_INIT,
                args0: [
                    {
                        type: 'field_image',
                        src: gesIconUrl,
    ...
    Blockly.Blocks.gesture_read = {
        init: function () {
            this.jsonInit({
                message0: '%1',
                message1: Blockly.Msg.GESTURE_READ,
                args0: [
                    {
                        type: 'field_image',
                        src: gesIconUrl,
                ...
                args1: [
                    {
                        ...
                        name: 'unit',
                        options: [
                            ['Right', 'GES_RIGHT_FLAG'],
                            ['Left', 'GES_LEFT_FLAG'],
                            ['Up', 'GES_UP_FLAG'],
                            ['Down', 'GES_DOWN_FLAG'],
                            ['Forward', 'GES_FORWARD_FLAG'],
                            ['Backward', 'GES_BACKWARD_FLAG'],
                            ['Clockwise', 'GES_CLOCKWISE_FLAG'],
                            ['anti-clockwise', 'GES_COUNT_CLOCKWISE_FLAG'],
                            ['wave', 'GES_WAVE_FLAG'],
