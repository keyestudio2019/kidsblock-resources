...
function addToolbox () {
    ...
    return `
<category name="%{BKY_DS1307_CATEGORY}" id="DS1307_CATEGORY" colour="#42CCFF" secondaryColour="#42CCFF" iconURI="${dsIconUrl}">
    <block type="ds1307_init" id="ds1307_init">

    </block>

    <block type="ds1307_set_sys" id="ds1307_set_sys">

    </block>

    <block type="ds1307_set_time" id="ds1307_set_time">
	    <value name="year">
    ...
    <block type="ds1307_now" id="ds1307_now">

    </block>

    <block type="ds1307_read" id="ds1307_read">
