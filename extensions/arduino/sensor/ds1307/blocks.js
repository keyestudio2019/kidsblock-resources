...
function addBlocks (Blockly) {
    ...
    Blockly.Blocks.ds1307_init = {
        init: function () {
            this.jsonInit({
                message0: '%1',
                message1: Blockly.Msg.DS1307_INIT,
                args0: [
                    {
                        type: 'field_image',
                        src: dsIconUrl,
    ...
    Blockly.Blocks.ds1307_set_sys = {
        init: function () {
            this.jsonInit({
                message0: '%1',
                message1: Blockly.Msg.DS1307_SET_SYS_TIME,
                args0: [
                    {
                        type: 'field_image',
                        src: dsIconUrl,
    ...
    Blockly.Blocks.ds1307_set_time = {
        init: function () {
            this.jsonInit({
                message0: '%1',
                message1: Blockly.Msg.DS1307_SET_TIME,
                args0: [
                    {
                        type: 'field_image',
                        src: dsIconUrl,
    ...
    Blockly.Blocks.ds1307_now = {
        init: function () {
            this.jsonInit({
                message0: '%1',
                message1: Blockly.Msg.DS1307_SET_NOW,
                args0: [
                    {
                        type: 'field_image',
                        src: dsIconUrl,
    ...
    Blockly.Blocks.ds1307_read = {
        init: function () {
            this.jsonInit({
                message0: '%1',
                message1: Blockly.Msg.DS1307_READ,
                args0: [
                    {
                        type: 'field_image',
                        src: dsIconUrl,
